...
void LpmConfigurationProxy::updateCurrentLpmEntries(void)
{
    switch (lpmMode())
    {
        ...
        case LpmMode::Standard:
            ...
            {
                m_currentLpmEntries.clear();
                throw dptf_exception("Invalid LPM mode boss - " + GccFix::to_string(lpmModeBoss()));
            }
            break;
        ...
        default:
            throw dptf_exception("Invalid LPM mode - " + GccFix::to_string(lpmMode()));
    }
...
void LpmConfigurationProxy::allocateConfigReader(LpmConfigurationVersion::Type version)
{
    ...
    {
        throw dptf_exception("Invalid LPM version - " + GccFix::to_string(version));
    }
}

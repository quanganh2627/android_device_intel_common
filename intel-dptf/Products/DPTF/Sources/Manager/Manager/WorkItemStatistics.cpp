...
XmlNode* WorkItemStatistics::getXml(void)
{
    ...
    workItemStatistics->addChild(XmlNode::createDataElement("total_deferred_work_items_executed",
        GccFix::to_string(m_totalDeferredWorkItemsExecuted)));
    workItemStatistics->addChild(XmlNode::createDataElement("total_immediate_work_items_executed",
        GccFix::to_string(m_totalImmediateWorkItemsExecuted)));
    ...
    for (UIntN i = 0; i < FrameworkEvent::Max; i++)
    {
        ...
        workItem->addChild(XmlNode::createDataElement("total_executed", GccFix::to_string(totalExecuted)));

        workItem->addChild(XmlNode::createDataElement("average_queue_time", GccFix::to_string(averageQueueTime)));
        workItem->addChild(XmlNode::createDataElement("min_queue_time",
            GccFix::to_string(m_immediateWorkItemStatistics[i].minQueueTimeMilliseconds)));
        workItem->addChild(XmlNode::createDataElement("max_queue_time",
            GccFix::to_string(m_immediateWorkItemStatistics[i].maxQueueTimeMilliseconds)));

        workItem->addChild(XmlNode::createDataElement("average_execution_time", GccFix::to_string(averageExecutionTime)));
        workItem->addChild(XmlNode::createDataElement("min_execution_time",
            GccFix::to_string(m_immediateWorkItemStatistics[i].minExecutionTimeMilliseconds)));
        workItem->addChild(XmlNode::createDataElement("max_execution_time",
            GccFix::to_string(m_immediateWorkItemStatistics[i].maxExecutionTimeMilliseconds)));
    }

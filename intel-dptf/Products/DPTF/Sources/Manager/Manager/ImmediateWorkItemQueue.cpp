...
XmlNode* ImmediateWorkItemQueue::getXml(void) const
{
    ...
    immediateQueueStastics->addChild(XmlNode::createDataElement("current_count", GccFix::to_string(m_queue.size())));
    immediateQueueStastics->addChild(XmlNode::createDataElement("max_count", GccFix::to_string(m_maxCount)));

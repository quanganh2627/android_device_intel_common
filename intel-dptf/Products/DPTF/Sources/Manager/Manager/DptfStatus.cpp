...
std::string DptfStatus::getPoliciesGroup()
{
    ...
    for (UIntN policyIndex = 0; policyIndex < policyCount; policyIndex++)
    {
        try
        {
            ...
            XmlNode* policyId = XmlNode::createDataElement("id", GccFix::to_string(policyIndex));
...
std::string DptfStatus::getFrameworkGroup()
{
    ...
    XmlNode* moduleId = XmlNode::createDataElement("id", GccFix::to_string(0));
    ...
    moduleId = XmlNode::createDataElement("id", GccFix::to_string(1));
    module->addChild(moduleId);
...
XmlNode* DptfStatus::getXmlForFrameworkLoadedPolicies()
{
    ...
    for (UIntN i = 0; i < policyCount; i++)
    {
        try
        {
            ...
            XmlNode* policyIndex = XmlNode::createDataElement("policy_index", GccFix::to_string(i));

...
fastboot_flashfile:
	...
	$(SUPPORT_PATH)/publish_build.py '$@' $(TARGET_PRODUCT) $(TARGET_DEVICE) $(PUBLISH_TARGET_BUILD_VARIANT) $(FILE_NAME_TAG) $(TARGET_BOARD_SOC) $(TARGET_USE_XEN)
...
blank_flashfiles:
	...
	$(SUPPORT_PATH)/publish_build.py 'blankphone' $(TARGET_PRODUCT) $(TARGET_DEVICE) $(PUBLISH_TARGET_BUILD_VARIANT) $(FILE_NAME_TAG) $(TARGET_BOARD_SOC) $(TARGET_USE_XEN)
else
blank_flashfiles:
...
publish_modem:
	...
	SKIP_NVM=$(BOARD_SKIP_NVM) \
	$(SUPPORT_PATH)/publish_build.py 'modem' $(TARGET_PRODUCT) $(TARGET_DEVICE) $(PUBLISH_TARGET_BUILD_VARIANT) $(FILE_NAME_TAG) $(TARGET_BOARD_SOC) $(TARGET_USE_XEN)
